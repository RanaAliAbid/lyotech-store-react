          ...
          <Grid container spacing={3}>
            <Grid item md={6} xs={12}>
              ...
              <div className={`${styles['wrapBox']} ${styles['addresses']}`}>
                ...
                <Typography variant="body1">
                  {userAddressList?.address?.defaultAddress?.code}-
              ...
              >
                <div className={styles.addressesType}>
                  <Typography variant="h4">
                    ...
                    {formAddress?.shippingAddress?.firstName}{' '}
                    {formAddress?.shippingAddress?.lastName}
                  </Typography>
                  <Typography variant="h6">
                ...
                <Typography variant="body1">
                  {formAddress?.shippingAddress?.address}
                  <br /> {formAddress?.shippingAddress?.city}&nbsp;
                ...
                <Typography variant="body1">
                  ...
                  {formAddress?.shippingAddress?.phone}
                </Typography>
              </div>
            </Grid>
          </Grid>
