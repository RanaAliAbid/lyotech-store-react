                  ...
                  >
                    <div className={styles.boxInfo}>
                      ...
                      <div className={styles.boxInfoBody}>
                        <List>
                          <ListItem>{t('details1')}</ListItem>
                          <ListItem>{t('details2')}</ListItem>

                          <ListItem>{t('details3')}</ListItem>

                          <ListItem>{t('details4')}</ListItem>
                    ...
                    <div className={styles.boxInfo}>
                      <div className={styles.wrapSubTitle}>
                        <Typography variant="h4">{t('subheader2')}</Typography>
                      ...
                      <div className={styles.boxInfoBody}>
                        <List>
                          <ListItem>{t('details6')}</ListItem>
                          <ListItem>{t('details7')}</ListItem>

                          <ListItem>{t('details8')}</ListItem>

                          <ListItem>{t('details9')}</ListItem>

                          <ListItem>{t('details10')}</ListItem>
                        </List>
                      </div>
                    </div>
                  </div>
