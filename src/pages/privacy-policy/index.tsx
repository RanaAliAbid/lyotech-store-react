                                        ...
                                        <List>
                                            ...
                                            <ListItem>
                                                ...
                                                <Typography variant="h5">
                                                    This Privacy and Cookie Policy (“Policy”) governs the access to and use of all parts of the website and services branded as LYOTECH LABS (“Lyotech”, “we”, “our”, “us”) and referring to the domain <a href='https://lyotechlabs.com/'>
                                                        https://lyotechlabs.com/</a> and <a href='https://shop.lyotechlabs.com/'>https://shop.lyotechlabs.com/</a> (hereinafter referred as the “Platform”) and all documents, data, materials or other information made available on the Platform
                                                </Typography>
                                        ...
                                        <List className={styles.orderedListDecimal}>
                                            ...
                                            <ListItem>
                                                ...
                                                <List>
                                                    <ListItem>
                                                        <Typography variant="h5">
                                                            At LYOTECH Labs, your privacy is a priority. Personal data is stored on our secure servers, following internal privacy and security protocols
                                                        </Typography>
                                                    </ListItem>
                                                    ...
                                                    <ListItem>
                                                        <Typography variant="h5">
                                                            We take appropriate steps to ensure data privacy and security including through various hardware and software methodologies. However, LYOTECH LABS cannot guarantee the security of any information that is disclosed online.
                                                        </Typography>
                                                    </ListItem>
                                                </List>
                                            </ListItem>
