                                ...
                                <Grid item md={8} xs={12}>
                                    <Grid container spacing={3}>
                                        <Grid item md={6} xs={12}>
                                            ...
                                            <div className={`${styles["wrapBox"]} ${styles["addresses"]}`}>
                                    ...
                                    <div className={styles.wrapBox}>
                                        <div className={styles.flexBox}>
                                            ...
                                            <div className={styles.formControl}>
                                                ...
                                                <Input className={styles.formInput} placeholder="Country / Region" />
                                            </div>

                                            <div className={styles.formControl}>
                                                <label className={styles.formLabel}> State </label>
                                                <Input className={styles.formInput} placeholder="State" />
                                            </div>

                                            <div className={styles.formControl}>
                                                <label className={styles.formLabel}> Town / City * </label>
                                                <Input className={styles.formInput} placeholder="Town / City" />
                                            </div>

                                            <div className={styles.formControl}>
                                                <label className={styles.formLabel}> Partner User ID * </label>
                                                <Input className={styles.formInput} placeholder="Partner User ID " />
                                            </div>

                                            <div className={styles.formControl}>
                                                <label className={styles.formLabel}> Address line 1 * </label>
                                                <Input className={styles.formInput} placeholder="Address line 1" />
                                            </div>

                                            <div className={styles.formControl}>
                                                <label className={styles.formLabel}> Address line 2 * </label>
                                                <Input className={styles.formInput} placeholder="Address line 2" />
                                            </div>
                                        </div>

                                        <div className={styles.addressBox}>
                                            <FormControlLabel control={<Checkbox size="small" defaultChecked />} label="Billing Address same as shipping address." />
                                            <Typography variant="h6" >
                                    ...
                                    <div className={`${styles["wrapBox"]} ${styles["paymentBox"]}`} >
                                        ...
                                        >
                                            <ListItem className={`${paymentType === "crypto" ? styles.show : ""}`}>
                                                <div className={styles.paymentTypelogo}>
                                                    <div className={styles.lyomc}>
                                                        <FormControlLabel value="crypto" control={<Radio size="small" checked={paymentType === "crypto"} />} label="" />
                                                ...
                                                <div className={styles.payInfoBox}>
                                                    <div className={styles.note}>
                                                        <Typography variant="h5">
                                                            Pay with your crypto currencies via our super-cool payment gateway.
                                                        </Typography>
                                                    </div>
                                                </div>
                                            </ListItem>

                                            <ListItem className={`${paymentType === "creditCard" ? styles.show : ""}`} >
                                                <div className={styles.paymentTypelogo}>
                                                    <div className={styles.lyomc}>
                                                        <FormControlLabel value="creditCard" control={<Radio size="small" checked={paymentType === "creditCard"} />} label="Credit card" />
                                                    </div>
                                                ...
                                                <div className={styles.payInfoBox}>
                                                    <Grid item md={12} xs={12}>
                                                        <div className={styles.formControl}>
                                                            ...
                                                            <Input className={styles.formInput} placeholder="0000 0000 0000 0000" />
                                                        </div>
                                                    </Grid>
                                                    <Grid container className={styles.payInline}>
                                                        <Grid item md={6} xs={12}>
                                                            <div className={styles.formControl}>
                                                                ...
                                                                <Input className={styles.formInput} placeholder="MM YYYY" />
                                                            </div>
                                                        </Grid>
                                                        <Grid item md={6} xs={12}>
                                                            <div className={styles.formControl}>
                                                    ...
                                                    <FormControlLabel control={<Checkbox size="small" defaultChecked />} label="Save payment information to my account for future purchases." />
                                                    <div className={styles.note}>
                                                        <Typography variant="h5">
