                                        ...
                                        <List>
                                            ...
                                            <ListItem>
                                                <Typography variant="h5">
                                                    These Terms and Conditions (“Terms”) are made between the customer (“Customer(s)”, “you”, “your”) and LYOTECH LABS (“LYOTECH LABS”, “we”, “us”, “ours”) and govern your access to and use of all parts of the website and mobile application branded as LYOTECH LABS and referring to the domain <Link href='lyotechlabs.com'>lyotechlabs.com
                                                    </Link>  and <Link href="https://shop.lyotechlabs.com/">https://shop.lyotechlabs.com/</Link>  (the “Website”, “App”).
                                                </Typography>
                                            </ListItem>
                                        ...
                                        <List className={styles.orderedListDecimal}>
                                            <ListItem>
                                                ...
                                                <List>
                                                    ...
                                                    <ListItem>
                                                        <Typography variant="h5">
                                                            LYOTECH LABS produces a range of Hardware and Services, as can be found on our Website.
                                                        </Typography>
                                                    </ListItem>

                                                    <ListItem>
                                                        <Typography variant="h5">
                                                            As a Customer of LYOTECH LABS you acknowledge that each Hardware and Service is sold on an as and when basis determined by availability.
                                                        </Typography>
                                                    </ListItem>

                                                    <ListItem>
                                                        <Typography variant="h5">
                                                            LYOTECH LABS makes no warranties or representations that the Hardware or Services will be fit for any purpose other than the ones explicitly stated on our Website. All Products and Services provided on our website are for personal use only; none of these Products and Services are authorized for commercial or industrial use, unless it is explicitly stated.
                                                        </Typography>
                                                    </ListItem>
                                                    ...
                                                    <ListItem>
                                                        <Typography variant="h5">
                                                            Each Hardware and/or Service may be subject to additional terms and conditions, in which case these Terms will be duly incorporated into as a result of your acceptance being a Customer of LYOTECH LABS.
                                                        </Typography>
                                                    </ListItem>
                                            ...
                                            <ListItem>
                                                ...
                                                <List>
                                                    ...
                                                    <ListItem>
                                                        <Typography variant="h5">
                                                            LYOTECH LABS will never under any circumstances ask you for your passwords or any authentication codes, and we assume no responsibility for any loss that you may sustain due to compromise of account login credentials due to no fault of LYOTECH LABS and/or failure or act on any notices or alerts that we may send you.
                                                        </Typography>
                                                    </ListItem>
                                                </List>
                                            </ListItem>
                                            ...
                                            <ListItem>
                                                ...
                                                <List >
                                                    <ListItem>
                                                        <Typography variant="h5">
                                                            Our Privacy & Cookies Policy which can be found at
                                                            <Link href="https://docs.lyotechlabs.com/legal-documents/privacy-and-cookies-policy">https://docs.lyotechlabs.com/legal-documents/privacy-and-cookies-policy</Link>
                                                            that governs access to and use all parts of our Website and it applies to all Customers and others who access or use our Website. The purpose of the Privacy Policy describes how, why and when LYOTECH LABS collects, processes and manages Customers’ personal data through the Website, and as previously mentioned is duly incorporated into these Terms by reference.
                                                        </Typography>
                                                    </ListItem>
                                                </List>
                                            </ListItem>
                                            ...
                                            <ListItem>
                                                ...
                                                <List>
                                                    <ListItem>
                                                        <Typography variant="h5">
                                                            LYOTECH LABS Hardware and Services are independent of their activities which may be conducted through third parties, we do not make any warranties or representations regarding the operation of our third party providers and will not be liable for any loss or damage endured by the Customer as a result of such third parties.
                                                        </Typography>
                                                    </ListItem>

                                                    <ListItem>
                                                        <Typography variant="h5">
                                                            By purchasing a Hardware or Service you acknowledge and accept that the capabilities may include engaging in activities utilizing blockchain technology and more. These activities are of a risky and uncertain nature that may result in financial loss or other such losses, for which LYOTECH LABS bears no responsibility. It is the sole responsibility of the Customer to educate themselves on the activities they choose to engage in, and the risks associated with such activities. If you are not comfortable assuming these risks, you should not access or engage in transactions using blockchain-based technology.
                                                        </Typography>
                                                    </ListItem>
                                            ...
                                            <ListItem>
                                                ...
                                                <List>
                                                    <ListItem>
                                                        <Typography variant="h5">
                                                            The price of each Hardware and Service offered by LYOTECH LABS is subject to variability and may be changed at the sole discretion of LYOTECH LABS. Once a payment has been made and an order confirmation has been received, the price of the purchased items or services cannot be changed. It is the Customer's responsibility to visit the Website as needed to stay updated on the latest pricing information.
                                                        </Typography>
                                                    </ListItem>
                                                    ...
                                                    <ListItem>
                                                        <Typography variant="h5">
                                                            LYOTECH LABS accepts card payments, including Visa and Mastercard credit/debit cards which can be made in AED or EURO.
                                                        </Typography>
                                                    </ListItem>
                                                    ...
                                                    <ListItem>
                                                        <Typography variant="h5">
                                                            Users paying via card payments must retain a copy of transaction records and LYOTECH LABS’ policies and rules.
                                                        </Typography>
                                                    </ListItem>
                                                    ...
                                                    <ListItem>
                                                        <Typography variant="h5">
                                                            ...
                                                            <Link href='https://docs.lyotechlabs.com/legal-documents/delivery-policy'> https://docs.lyotechlabs.com/legal-documents/delivery-policy</Link> and is duly incorporated into these Terms by reference should you purchase Hardware, and is subject to change at the sole discretion of LYOTECH LABS. It is the Customers responsibility to regularly check these changes, especially at the time of purchase.
                                                        </Typography>
                                                    </ListItem>
                                                </List>
                                            </ListItem>
                                                ...
                                                <List>
                                                    ...
                                                    <ListItem>
                                                        ...
                                                        <List>
                                                            ...
                                                            <ListItem>
                                                                <Typography variant="h5">
                                                                    Standard warranty is provided by third party manufacturers, not LYOTECH LABS. LYOTECH LABS bears no responsibility for the manufacturer’s warranty, and Customers are advised to read the terms of such warranty carefully before purchasing.
                                                                </Typography>
                                                            </ListItem>
                                            ...
                                            <ListItem>
                                                ...
                                                <List>
                                                    <ListItem>
                                                        <Typography variant="h5">
                                                            You agree and acknowledge that you are making use of our services at your own risk and they are offered on an “AS IS” and “AS AVAILABLE” basis without any representation or warranty. In accordance with the applicable law, we exclude all express or implied warranties, terms and conditions including, but not limited to, implied warranties of merchantability, fitness for a particular purpose and non-infringement. In addition to the extent permitted by applicable law, in no event whether as a result of Product defect, breach of contract, warranty; tort; copyright, trademark, trade secret, patent and other intellectual property infringement or otherwise, shall LYOTECH LABS or any of its agents or affiliates be liable for any special, consequential, incidental, indirect or exemplary damages, including, but not limited to, loss of profit, loss of use of the Products, cost of substitute Product.
                                                        </Typography>
                                                    </ListItem>

                                                    <ListItem>
                                                        <Typography variant="h5">
                                                            No one other than LYOTECH LABS, LYOTECH LABS affiliates and the Customer to these Terms, shall have any right to enforce any of its provisions.
                                                        </Typography>
                                                    </ListItem>
